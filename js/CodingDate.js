		...
		"details_wz":[
			{
				"id":'0027',
				"time":'2021/06/25',
				"title":'Windows 11 操作系统正式发布',
				"question_type":'E',
				"content1":'昨天晚上11点钟，微软举办了win11的发布会，由于疫情的原因，本次发布会采用的是线上的形式进行的，和之前苹果的iOS15,华为的HarmonyOS 2 发布会一样。本次发布会主要为我们展示了继windows10后，微软在windows操作系统上做出的改变，包括新的UI，操作方式，软件市场与开发者入口以及对Android应用的支持。',
				"duanluo":[
					{
						"title":'UI（图形用户界面）',
						"img":'../imgs/details/0027/1.png',
						"main":"如上图所示，win11重做了用户界面，总的来说还是不错的 我比较看重UI，win10实在是看习惯了，之前用过一段时间的Mac，特别的喜欢，这次微软终于是有所改变了，win11的UI风格终于趋于年轻化，所以这驱使我去装win11",					
						"main2":"",
					},
					{
						"title":'操作方式',
						"img":'../imgs/details/0027/2.png',
						"main":"我们所熟知的开始任务栏被调在了中心，类似MacOS的Dock栏，个人感觉挺好的，因为你的鼠标不管是从左边滑动还是右边滑动，都能以最快的方式接触到任务栏，去切换桌面的应用。",
					},
					{
						"title":'软件市场与开发者入口',
						"img":'../imgs/details/0027/3.png',
						"main":"我也是第一时间在我的PC上安装了win11，目前体验良好。微软的高管强调win11是10年来微软最大的更新。过去，微软的应用下载商城是和ie一样的存在，饱受诟病，显然，微软想改变现在的状况。微软重做了Microsoft Store,开发者可以在里边发布自己的软件，微软不会收取任何的佣金，并且收获全归开发者所有，显然，这是在吸引更多开发者的加入。",
					},
					{
						"title":'对于对Android应用的支持',
						"img":'../imgs/details/0027/4.png',
						"main":"win11最吸引人的一个地方莫过于用户可以在Microsoft Store中下载Android应用，并直接点击安装运行。目前win11的最高版本为预览版，国内用户暂时体会不到，比较遗憾！",
						"main":"数据来自：https://www.microsoft.com/en-us/windows/event",
					},
				],
			},
			{
